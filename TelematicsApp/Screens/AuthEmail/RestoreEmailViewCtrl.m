...
//#import "Helpers.h"
//
//@interface RestoreEmailViewCtrl () <UITextFieldDelegate> {
//    int currSeconds;
//}
//
...
//@end
//
//@implementation RestoreEmailViewCtrl
//
//- (void)viewDidLoad {
//    [super viewDidLoad];
//    
...
//    NSMutableAttributedString *backOtherPhone = [[NSMutableAttributedString alloc] initWithString:localizeString(@"Sign in with another email")];
...
//        [self errorRestoreEmailFunction];
//        return;
//    }
//    
//    NewPassEmailViewCtrl* newPassEmail = [self.storyboard instantiateViewControllerWithIdentifier:@"NewPassEmailViewCtrl"];
//    newPassEmail.enteredEmail = self.enteredEmail;
...
//    regData.resetTypeDataContract = @"Email";
//    
...
//                [self.errorHandler showErrorMessages:@[localizeString(@"Email address isn't correct.")]];
//            } else {
...
//}
//
//- (void)errorRestoreEmailFunction {
