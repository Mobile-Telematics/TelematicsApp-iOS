...
//  TelematicsApp
//
//  Created by DATA MOTION PTE. LTD. on 28.05.21.
...
//  //VOLATILY BACKUP
//    NSNumber *min = [_data valueForKeyPath:@"@min.floatValue"];
//    NSInteger index = [_data indexOfObject:min];
//
//    NSNumber *minX = @([min intValue]);
//    if (![min isEqual:@100] && min.intValue > 20) {
//        minX = @([min intValue] - 20);
//    }
//    //NSNumber *minX = @([min intValue] - 20);
//
//    [_data replaceObjectAtIndex:index withObject:[NSNumber numberWithFloat:minX.floatValue]];
