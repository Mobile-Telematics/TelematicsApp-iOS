...
- (void)viewDidLoad {
    ...
    self.deleteVehicleBtn.layer.cornerRadius = 20.0;
    self.deleteVehicleBtn.layer.borderWidth = 1.0;
    self.deleteVehicleBtn.layer.borderColor = [Color officialDarkRedColor].CGColor;
