...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        [_imageView3.layer setBorderColor: [[Color officialWhiteColor] CGColor]];
        ...
        [_imageView2.layer setBorderColor: [[Color officialWhiteColor] CGColor]];
        ...
        [_imageView1.layer setBorderColor: [[Color officialWhiteColor] CGColor]];
