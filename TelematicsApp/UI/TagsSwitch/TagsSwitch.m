...
@implementation TagsSwitch

- (instancetype)init
{
    self = [super init];
    if (self) {
        [NSException raise:@"TagsSwitchException" format:@"Init call is prohibited, use initWithStringsArray: method"];
    }
...
{
    return [[TagsSwitch alloc] initWithStringsArray:strings];
}
