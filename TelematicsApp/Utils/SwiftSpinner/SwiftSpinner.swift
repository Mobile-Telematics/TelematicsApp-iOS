...
//        blurView.contentView.addSubview(vibrancyView)
    ...
    private let outerCircleDefaultColor = Color.officialMainAppColor().cgColor
    ...
    private let innerCircleDefaultColor = Color.officialMainAppColor().cgColor
    ...
    @discardableResult
    @objc public class func show(progress: Double, title: String) -> SwiftSpinner {
    ...
    public func addTapHandler(_ tap: @escaping (()->()), subtitle subtitleText: String? = nil) {
        ...
        if subtitleText != nil {
            ...
            if let subtitle = subtitleLabel {
                ...
                subtitle.font = UIFont(name: self.currentTitleFont.familyName, size: currentTitleFont.pointSize * 1.2)
                subtitle.textColor = Color.officialMainAppColor()
    ...
    private var blurEffectStyle: UIBlurEffect.Style = .prominent
